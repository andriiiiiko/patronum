function storeFilterState() {
    var showMy = document.querySelector('input[name="showMy"]').checked;
    var showActive = document.querySelector('input[name="showActive"]').checked;

    sessionStorage.setItem('showMy', showMy);
...
function submitForm() {
    ...
    if (showMy && showActive) {
        window.location.href = '/mvc/home/user/list/active';
    } else if (showMy) {
        window.location.href = '/mvc/home/user/list';
    } else if (showActive) {
