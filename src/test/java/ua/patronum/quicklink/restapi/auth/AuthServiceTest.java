...
class AuthServiceTest {
    ...
    void register_Registration_Success() {
        ...
        RegistrationRequest request = new RegistrationRequest("testUser", "Password123", "Password123");
    ...
    void register_UserAlreadyExists_Failed() {
        ...
        RegistrationRequest request = new RegistrationRequest("existingUser", "Password123", "Password123");
        ...
        verify(userService, never()).saveUser(any(User.class)); // Saving should not occur
    }
    ...
    void register_Invalid_Confirm_Password_Failed() {
        ...
        RegistrationRequest request = new RegistrationRequest("Test", "Test1234", "Test12");
        when(userService.findByUsername("Test")).thenReturn(null);
    ...
    void login_Success() {
        ...
        verify(userService, times(1)).findByUsername("Test");
        verify(passwordEncoder, times(1)).matches("Test1234", existingUser.getPassword());
    ...
    void login_Invalid_Password_Failed() {
        ...
        verify(userService, times(1)).findByUsername("Test");
        verify(passwordEncoder, times(1)).matches("Test5678", existingUser.getPassword());
